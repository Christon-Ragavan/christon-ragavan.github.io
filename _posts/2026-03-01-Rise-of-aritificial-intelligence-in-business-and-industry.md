---
title: "Artificial Intelligence (AI) in Business and Industry [in-progress]"
date: 2026-03-01
tags: [Predictive Maintenance, Deep Learning, Machine Learning]
excerpt: "Business, Artificial Intelligence, Deep Learning, Machine Learning"
mathjax: "true"
---

# Introductions

- Emerging technologies always reshapes teh business landscape, one such technology distributing of this era is AI 
- AI systems can have different types of compositions; Natual language processing, knowledge representations,automated reasoning, actionable automations (AI agents), RAG systems etc.
- It is important to synthesis the knowledge before identifying the trends and potential business gaps
- Applications are wide across industries 
  - Healthcare 
    - diagnostics 
    - drug discovery
    - digital twin for diagnosis 
  - Manufacturing
    - Automation / Robots to improve production efficiency 
    - Quality control 
    - Predictive maintenance to identify the failure 
    - optimizing inventory management
    - Improve logistic routing
  - Applications on General Business Side
    - Operational efficiency
    - Enhanced decision-making
    - Personalised Customner experience
    - Customer feedback systems 
    - Cybersecurity

# A structured view of AI technology Domains 

| Functional Area | AI Capabilities |
|----------|------|
...
| Socital Impact | AI in disaster response; Environmental monitoring; Smart home devices; Traffic optimization; Waste management |


# Comprehensive analysis of impacts of AI on Business innovation 
